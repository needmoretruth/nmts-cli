 ...
 */
export const SUPPORT_LONG: readonly string[] = [
...
export const ATTACH_LOG_TEXT: readonly string[] = [
...
export function categoryLines(): string[] {
...
export const SUPPORT_USAGE: readonly string[] = [
...
export function supportHelpText(): string {
  return [
