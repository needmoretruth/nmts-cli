 ...
 */
const WORDS = ["standard", "pow2"] as const;
...
export async function padding(wanted: string | undefined, options: PaddingOptions = {}): Promise<number> {
  ...
  if (wanted === undefined || wanted === "") {
    ...
    const at: PaddingWord = list.manifest?.settings?.paddingMode === "pow2" ? "pow2" : "standard";
  ...
  const mode: PaddingMode = wanted === "pow2" ? "pow2" : "padme";
