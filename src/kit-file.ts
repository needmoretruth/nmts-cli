...
import { RECOVERY_TOOL_URL } from "./recovery-release.ts";
 ...
 */
export function accountIdFingerprint(accountId: string): string {
...
export function buildRecoveryKit(input: BuildKitInput): { filename: string; content: string } {
