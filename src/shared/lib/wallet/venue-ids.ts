...
export const DEEPBOOK_PACKAGE_IDS: Readonly<Record<"mainnet" | "testnet", string>> = {
...
export const BLUEFIN_PACKAGE_IDS: Readonly<Record<"mainnet" | "testnet", string | null>> = {
  testnet: null,
...
export const DEEPBOOK_WAL_SUI_POOLS: Readonly<Record<"mainnet" | "testnet", string>> = {
...
export const DEEP_COIN_TYPES: Readonly<Record<"mainnet" | "testnet", string>> = {
...
export const BLUEFIN_UPGRADE_CAP_IDS: Readonly<Record<"mainnet" | "testnet", string | null>> = {
  testnet: null,
...
export const BLUEFIN_GLOBAL_CONFIG_IDS: Readonly<Record<"mainnet" | "testnet", string | null>> = {
  testnet: null,
...
export const BLUEFIN_WAL_SUI_POOLS: Readonly<Record<"mainnet" | "testnet", string | null>> = {
  testnet: null,
