...
export function helpText(version: string): string {
  return [
    ...
    `  padding [mode]        How file sizes are hidden: standard or pow2. Applies to the next uploads`,
    ...
    `                        share, receive, label, unlabel, padding, whoami --reveal,`,
    `                        recovery, balance, trial, extend, recovery-list, kit, update, notices,`,
    `                        devices, key new, create. \`key new\` puts the key string in the JSON`,
