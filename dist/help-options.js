...
export function optionLines() {
    return [
        ...
        `  --media <kind>        image, video or audio: only files of that kind (ls)`,
        ...
        `  --thumbnail           Send a video's preview picture with it, one frame taken by ffmpeg`,
        `                        (put); fetch only that picture (get)`,
        `  --thumbnail-file <f>  The picture to send as the video's preview instead (put)`,
