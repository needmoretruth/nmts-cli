...
const OPENS = ["ED25519", "Secp256k1", "Secp256r1"];
/**
...
export async function openerMessage(input) {
 ...
 */
export async function withSignature(input, use, hints = {}) {
 ...
 *   was made.
 */
export async function withRepeatedSignature(input, use, hints = {}) {
    const message = await openerMessage(input);
 ...
 */
async function judged(answer, message, address, hints) {
