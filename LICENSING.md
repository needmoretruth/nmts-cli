...
`nmts` is licensed under the **Apache License, Version 2.0**. The full text is in
[LICENSE](LICENSE), verbatim and unmodified.

It moved here from the GNU Affero General Public License on 2026-08-30. Copies you already have
under the AGPL stay under it — a licence that has been granted cannot be withdrawn — so this is a
loosening, not a change of terms under anyone's feet.
...
that you changed them (§4). Nothing is asked of you for merely *using* the program.
